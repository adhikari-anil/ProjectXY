...
// const Home = () => {
//   return (
//     <div className="h-[200px]w-full flex justify-center items-center px-4 sm:px-6 lg:px-8">
...
// Responsive Code to follow....

const Home = () => {
  return (
    <div className="w-full min-h-[calc(100vh-theme(spacing.16))] flex justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl flex flex-col justify-center items-center gap-8 animate-fadeIn">
        <div className="flex flex-col gap-5">
          ...
          <p className="font-light text-lg sm:text-xl text-white/90 max-w-xl text-center">
            Discover the key improvements your site needs to drive more sales.
            <span>Take the first step toward better results today!</span>
          </p>
        </div>
